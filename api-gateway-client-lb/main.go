...
import (
	...
	"github.com/golanguzb70/grpc-load-balancer-example/api-gateway-client-lb/api"
	"github.com/golanguzb70/grpc-load-balancer-example/api-gateway-client-lb/config"
	grpcclient "github.com/golanguzb70/grpc-load-balancer-example/api-gateway-client-lb/grpc-client"

	_ "github.com/golanguzb70/grpc-load-balancer-example/api-gateway-client-lb/api/docs"
